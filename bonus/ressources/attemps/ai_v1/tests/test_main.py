...
# test_main.py
##
"""! @brief Example program for running unit test functions """
...
class TestMainFunctions(unittest.TestCase):
    ...
    def print_debug(self, string: str, *args, **kwargs) -> None:
        ...
        @param *args optional arguments the user whishes to pass
        @param **kwargs optional arguments the user whishes to pass
        """
        if self.debug:
